...
describe('$sailsSocket', function() {
    ...
    afterEach(inject(function($exceptionHandler, $sailsConnection, $rootScope) {
        ...
        $rootScope.$digest();
        $sailsConnection.verifyNoOutstandingExpectation();
    }));
    ...
    describe('$sailsSocketProvider', function() {
        describe('interceptors', function() {
            it('should chain request, requestReject, response and responseReject interceptors', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    var response;
                    $sailsConnection.expect('GET', '/url/1/2').respond('response');
                    $sailsSocket({method: 'GET', url: '/url'}).then(function(r) {
                        response = r;
                    });
                    $rootScope.$apply();
                    $sailsConnection.flush();
            ...
            it('should verify order of execution', function() {
                ...
                inject(function($sailsSocket, $sailsConnection) {
                    var response;
                    $sailsConnection.expect('GET', '/url/outer/inner').respond('response');
                    $sailsSocket({method: 'GET', url: '/url'}).then(function(r) {
                        response = r;
                    });
                    $sailsConnection.flush();
        ...
        describe('request interceptors', function() {
            it('should pass request config as a promise', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    $sailsConnection.expect('POST', '/url').respond('');
            ...
            it('should allow manipulation of request', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    $sailsConnection.expect('GET', '/intercepted', null, function (headers) {
            ...
            it('should allow replacement of the headers object', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    $sailsConnection.expect('GET', '/url', null, function (headers) {
            ...
            it('should not manipulate the passed-in config', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    ...
                    $sailsConnection.expect('GET', '/intercepted').respond('');
                    $sailsSocket.get('/url');
                    $rootScope.$apply();
            ...
            it('should support interceptors defined as services', function() {
                ...
                inject(function($sailsSocket, $sailsConnection, $rootScope) {
                    $sailsConnection.expect('POST', '/intercepted').respond('');
    ...
    describe('the instance', function() {
        var $sailsConnection, $sailsSocket, $rootScope;
        ...
        beforeEach(inject(['$sailsConnection', '$sailsSocket', function($hb, $h) {
            $sailsConnection = $hb;
            $sailsSocket = $h;
        }]));

        it('should send GET requests if no method specified', inject(function($sailsConnection, $sailsSocket) {
            $sailsConnection.expect('GET', '/url').respond('');
            $sailsSocket({url: '/url'});
        }));

        it('should do basic request', inject(function($sailsConnection, $sailsSocket) {
            $sailsConnection.expect('GET', '/url').respond('');
            $sailsSocket({url: '/url', method: 'GET'});
        }));


        it('should pass data if specified', inject(function($sailsConnection, $sailsSocket) {
            $sailsConnection.expect('POST', '/url', 'some-data').respond('');
            $sailsSocket({url: '/url', method: 'POST', data: 'some-data'});
        }));


        describe('params', function() {
            it('should do basic request with params and encode', inject(function($sailsConnection, $sailsSocket) {
                $sailsConnection.expect('GET', '/url?a%3D=%3F%26&b=2').respond('');
                $sailsSocket({url: '/url', params: {'a=':'?&', b:2}, method: 'GET'});
            }));


            it('should merge params if url contains some already', inject(function($sailsConnection, $sailsSocket) {
                $sailsConnection.expect('GET', '/url?c=3&a=1&b=2').respond('');
                $sailsSocket({url: '/url?c=3', params: {a:1, b:2}, method: 'GET'});
            }));


            it('should jsonify objects in params map', inject(function($sailsConnection, $sailsSocket) {
                $sailsConnection.expect('GET', '/url?a=1&b=%7B%22c%22:3%7D').respond('');
                $sailsSocket({url: '/url', params: {a:1, b:{c:3}}, method: 'GET'});
            }));


            it('should expand arrays in params map', inject(function($sailsConnection, $sailsSocket) {
                $sailsConnection.expect('GET', '/url?a=1&a=2&a=3').respond('');
            ...
            it('should not encode @ in url params', function() {
                ...
                $sailsConnection.expect('GET', '/Path?!do%26h=g%3Da+h&:bar=$baz@1').respond('');
            ...
            it('should not double quote dates', function() {
                if (typeof msie == 'undefined' || msie < 9) return;
                    $sailsConnection.expect('GET', '/url?date=2014-07-15T17:30:00.000Z').respond('');
            ...
            describe('callbacks', function() {
                ...
                it('should pass in the response object when a request is successful', function() {
                    $sailsConnection.expect('GET', '/url').respond(207, 'my content', {'content-encoding': 'smurf'});
                ...
                it('should pass statusText in response object when a request is successful', function() {
                    $sailsConnection.expect('GET', '/url').respond(200, 'SUCCESS', {}, 'OK');
                    $sailsSocket({url: '/url', method: 'GET'}).then(function(response) {
                ...
                it('should pass statusText in response object when a request fails', function() {
                    $sailsConnection.expect('GET', '/url').respond(404, 'ERROR', {}, 'Not Found');
                ...
                it('should pass in the response object when a request failed', function() {
                    $sailsConnection.expect('GET', '/url').respond(543, 'bad error', {'request-id': '123'});
                    $sailsSocket({url: '/url', method: 'GET'}).then(null, function(response) {
            ...
            describe('response headers', function() {
                ...
                it('should return single header', function() {
                    $sailsConnection.expect('GET', '/url').respond('', {'date': 'date-val'});
                ...
                it('should return null when single header does not exist', function() {
                    $sailsConnection.expect('GET', '/url').respond('', {'Some-Header': 'Fake'});
                    callback.andCallFake(function(r) {
                ...
                it('should return empty object for jsonp request', function() {
                    ...
                    $sailsConnection.expect('JSONP', '/some').respond(200);
            ...
            describe('response headers parser', function() {
                ...
                describe('request headers', function() {
                    ...
                    it('should send custom headers', function() {
                        $sailsConnection.expect('GET', '/url', undefined, function(headers) {
                    ...
                    it('should set default headers for POST request', function() {
                        $sailsConnection.expect('POST', '/url', 'messageBody', function(headers) {
                            return headers['Accept'] == 'application/json, text/plain, */*' &&
                    ...
                    it('should set default headers for PUT request', function() {
                        $sailsConnection.expect('PUT', '/url', 'messageBody', function(headers) {
                            return headers['Accept'] == 'application/json, text/plain, */*' &&
                            headers['Content-Type'] == 'application/json;charset=utf-8';
                        }).respond('');
                    ...
                    it('should set default headers for PATCH request', function() {
                        $sailsConnection.expect('PATCH', '/url', 'messageBody', function(headers) {
                            return headers['Accept'] == 'application/json, text/plain, */*' &&
                            headers['Content-Type'] == 'application/json;charset=utf-8';
                        }).respond('');
                    ...
                    it('should set default headers for custom HTTP method', function() {
                        $sailsConnection.expect('FOO', '/url', undefined, function(headers) {
                            return headers['Accept'] == 'application/json, text/plain, */*';
                        }).respond('');
                    ...
                    it('should not set XSRF cookie for cross-domain requests', inject(function($browser) {
                        ...
                        $sailsConnection.expect('GET', 'http://www.test.com/url', undefined, function(headers) {
                    ...
                    it('should not send Content-Type header if request data/body is undefined', function() {
                        $sailsConnection.expect('POST', '/url', undefined, function(headers) {
                            return !headers.hasOwnProperty('Content-Type');
                        }).respond('');

                        $sailsConnection.expect('POST', '/url2', undefined, function(headers) {
                            return !headers.hasOwnProperty('content-type');
                        }).respond('');
                    ...
                    it('should NOT delete Content-Type header if request data/body is set by request transform', function() {
                        $sailsConnection.expect('POST', '/url', {'one' : 'two'}, function(headers) {
                    ...
                    it('should set the XSRF cookie into a XSRF header', inject(function($browser) {
                        ...
                        $sailsConnection.expect('GET', '/url', undefined, checkXSRF('secret')).respond('');
                        $sailsConnection.expect('POST', '/url', undefined, checkXSRF('secret')).respond('');
                        $sailsConnection.expect('PUT', '/url', undefined, checkXSRF('secret')).respond('');
                        $sailsConnection.expect('DELETE', '/url', undefined, checkXSRF('secret')).respond('');
                        $sailsConnection.expect('GET', '/url', undefined, checkXSRF('secret', 'aHeader')).respond('');
                        $sailsConnection.expect('GET', '/url', undefined, checkXSRF('secret2')).respond('');
                    ...
                    it('should send execute result if header value is function', inject(function() {
                        ...
                        $sailsConnection.expect('GET', '/url', undefined, checkHeaders).respond('');
                        $sailsConnection.expect('POST', '/url', undefined, checkHeaders).respond('');
                        $sailsConnection.expect('PUT', '/url', undefined, checkHeaders).respond('');
                        $sailsConnection.expect('PATCH', '/url', undefined, checkHeaders).respond('');
                        $sailsConnection.expect('DELETE', '/url', undefined, checkHeaders).respond('');
                    ...
                    //     });
                    //
                    //     $sailsConnection.expect('GET', '/url', undefined).respond('');
                ...
                describe('short methods', function() {
                    ...
                    it('get() should allow config param', function() {
                        $sailsConnection.expect('GET', '/url', undefined, checkHeader('Custom', 'Header')).respond('');
                        $sailsSocket.get('/url', {headers: {'Custom': 'Header'}});
                    });


                    it('should have delete()', function() {
                        $sailsConnection.expect('DELETE', '/url').respond('');
                        $sailsSocket['delete']('/url');
                    });


                    it('delete() should allow config param', function() {
                        $sailsConnection.expect('DELETE', '/url', undefined, checkHeader('Custom', 'Header')).respond('');
                        $sailsSocket['delete']('/url', {headers: {'Custom': 'Header'}});
                    });


                    it('should have head()', function() {
                        $sailsConnection.expect('HEAD', '/url').respond('');
                        $sailsSocket.head('/url');
                    });


                    it('head() should allow config param', function() {
                        $sailsConnection.expect('HEAD', '/url', undefined, checkHeader('Custom', 'Header')).respond('');
                    ...
                    it('post() should allow config param', function() {
                        $sailsConnection.expect('POST', '/url', 'some-data', checkHeader('Custom', 'Header')).respond('');
                        $sailsSocket.post('/url', 'some-data', {headers: {'Custom': 'Header'}});
                    });


                    it('should have put()', function() {
                        $sailsConnection.expect('PUT', '/url', 'some-data').respond('');
                        $sailsSocket.put('/url', 'some-data');
                    });


                    it('put() should allow config param', function() {
                        $sailsConnection.expect('PUT', '/url', 'some-data', checkHeader('Custom', 'Header')).respond('');
                    ...
                    //     $sailsConnection.expect('PATCH', '/url', 'some-data').respond('');
                    //     $sailsSocket.patch('/url', 'some-data');
                    //   });
                    //
                    //   it('patch() should allow config param', function() {
                    //     $sailsConnection.expect('PATCH', '/url', 'some-data', checkHeader('Custom', 'Header')).respond('');
                    //     $sailsSocket.patch('/url', 'some-data', {headers: {'Custom': 'Header'}});
                    //   });
                    //
                    //   it('should have jsonp()', function() {
                    //     $sailsConnection.expect('JSONP', '/url').respond('');
                    //     $sailsSocket.jsonp('/url');
                    //   });
                    //
                    //
                    //   it('jsonp() should allow config param', function() {
                    //     $sailsConnection.expect('JSONP', '/url', undefined, checkHeader('Custom', 'Header')).respond('');
                ...
                describe('scope.$apply', function() {
                    ...
                    it('should $apply after success callback', function() {
                        $sailsConnection.when('GET').respond(200);
                    ...
                    it('should $apply after error callback', function() {
                        $sailsConnection.when('GET').respond(404);
                        $sailsSocket({method: 'GET', url: '/some'});
                        $sailsConnection.flush();
                        expect($rootScope.$apply).toHaveBeenCalledOnce();
                    });
                ...
                describe('transformData', function() {
                    ...
                    describe('request', function() {
                        ...
                        describe('default', function() {
                            ...
                            it('should transform object into json', function() {
                                $sailsConnection.expect('POST', '/url', '{"one":"two"}').respond('');
                                $sailsSocket({method: 'POST', url: '/url', data: {one: 'two'}});
                            });


                            it('should ignore strings', function() {
                                $sailsConnection.expect('POST', '/url', 'string-data').respond('');
                            ...
                            //     var file = {
                            //         some: true,
                            //         // $sailsConnection compares toJson values by default,
                            ...
                            //
                            //     $sailsConnection.expect('POST', '/some', file).respond('');
                        ...
                        //
                        //         $sailsConnection.expect('POST', '/url', '[object Blob]').respond('');
                        //         $sailsSocket({ method: 'POST', url: '/url', data: blob });
                        //     });


                            it('should have access to request headers', function() {
                                $sailsConnection.expect('POST', '/url', 'header1').respond(200);
                            ...
                            it('should pipeline more functions', function() {
                                ...
                                $sailsConnection.expect('POST', '/url', 'REQ-FIRST:V1').respond(200);
                                $sailsSocket.post('/url', 'req', {
                                    headers: {h1: 'v1'},
                        ...
                        describe('response', function() {
                            ...
                            describe('default', function() {
                                ...
                                it('should deserialize json objects', function() {
                                    $sailsConnection.expect('GET', '/url').respond('{"foo":"bar","baz":23}');
                                ...
                                it('should deserialize json arrays', function() {
                                    $sailsConnection.expect('GET', '/url').respond('[1, "abc", {"foo":"bar"}]');
                                    $sailsSocket({method: 'GET', url: '/url'}).success(callback);
                                    $sailsConnection.flush();
                                ...
                                it('should not deserialize tpl beginning with ng expression', function() {
                                    $sailsConnection.expect('GET', '/url').respond('{{some}}');
                            ...
                            it('should have access to response headers', function() {
                                $sailsConnection.expect('GET', '/url').respond(200, 'response', {h1: 'header1'});
                                $sailsSocket.get('/url', {
                            ...
                            it('should pipeline more functions', function() {
                                ...
                                $sailsConnection.expect('POST', '/url').respond(200, 'resp', {h1: 'v1'});
                    ...
                    describe('cache', function() {
                        ...
                        function doFirstCacheRequest(method, respStatus, headers) {
                            $sailsConnection.expect(method || 'GET', '/url').respond(respStatus || 200, 'content', headers);
                        ...
                        it('should cache JSONP request when cache is provided', inject(function($rootScope) {
                            $sailsConnection.expect('JSONP', '/url?cb=JSON_CALLBACK').respond('content');
                        ...
                        it('should not cache POST request', function() {
                            ...
                            $sailsConnection.expect('POST', '/url').respond('content2');
                        ...
                        it('should not cache PUT request', function() {
                            ...
                            $sailsConnection.expect('PUT', '/url').respond('content2');
                        ...
                        it('should not cache DELETE request', function() {
                            ...
                            $sailsConnection.expect('DELETE', '/url').respond(206);
                        ...
                        it('should not cache non 2xx responses', function() {
                            ...
                            $sailsConnection.expect('GET', '/url').respond('content2');
                            $sailsSocket({method: 'GET', url: '/url', cache: cache}).success(callback);
                            $sailsConnection.flush();
                        ...
                        it('should use cache even if second request was made before the first returned', function() {
                            $sailsConnection.expect('GET', '/url').respond(201, 'fake-response');
                    ...
                    describe('$sailsSocket.defaults.cache', function () {
                        ...
                        it('should cache requests when no cache given in request config', function() {
                            ...
                            $sailsConnection.expect('GET', '/url').respond(200, 'content');
                        ...
                        it('should have less priority than explicitly given cache', inject(function($cacheFactory) {
                            ...
                            // Fill local cache.
                            $sailsConnection.expect('GET', '/url').respond(200, 'content-local-cache');
                            $sailsSocket({method: 'GET', url: '/url', cache: localCache});
                            $sailsConnection.flush();

                            // Fill default cache.
                            $sailsConnection.expect('GET', '/url').respond(200, 'content-default-cache');
                            $sailsSocket({method: 'GET', url: '/url'});
                            $sailsConnection.flush();
                ...
                describe('timeout', function() {
                    ...
                    it('should abort requests when timeout promise resolves', inject(function($q) {
                        ...
                        $sailsConnection.expect('GET', '/some').respond(200);
                        ...
                        $sailsSocket({method: 'GET', url: '/some', timeout: canceler.promise}).error(
                            ...
                            expect(callback).toHaveBeenCalled();
                            $sailsConnection.verifyNoOutstandingExpectation();
                            $sailsConnection.verifyNoOutstandingRequest();
                        }));
