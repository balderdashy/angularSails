...
angular
  ...
  .provider('SailsAssociation', function() {
    this.$get = ['$injector', 'SailsBelongsTo', function($injector, BelongsTo) {
  ...
  .provider('SailsBelongsTo', function() {
    this.$get = ['SailsAssociations', 'SailsHelpers', function(Associations, Helpers) {
  ...
  .provider('SailsAssociations', function() {
...
angular
    .module('sails.resource')
    .provider('SailsHelpers', function() {
        this.$get = ['SailsStringHelpers',function(SailsStringHelpers) {
...
angular
    .module('sails.resource')
    .provider('SailsQuerystring', function() {
        this.$get = function() {
            var querystring = {
...
angular
    .module('sails.resource')
    .provider('SailsParameterize', function() {
        this.$get = function() {
...
angular
    ...
    .provider('URLify', function() {
        this.$get = ['SailsParameterize', 'SailsQuerystring', function(parameterize, querystring) {
...
angular
    .module('sails.resource')
    .provider('SailsGET', function() {
        this.$get = ['$http', 'SailsDeferred', 'SailsAssociations', 'SailsHelpers', 'URLify',
...
angular
    .module('sails.resource')
    .provider('SailsBase', function() {
        this.$get = ['SailsAPI', 'SailsCollection', 'SailsAssociation', 'SailsAssociations',
            'SailsCache', 'SailsSerializer', 'SailsEventable', 'SailsValidations', '$http', '$q',
            '$injector', 'SailsDeferred', 'SailsGET', 'SailsMixin', 'URLify', 'SailsHelpers',
            function(API, Collection, Association, Associations,
                ...
                function Base() {
                    ...
                    // @API
                    // Instantiates a new sails.resource::API, which comes with methods for setting the
                    // URLs used by functions like $save, $create, $delete, and $update. See
                    // sails.resource::API for more details.
                    ...
                    // in sails.resource is that methods prefaced with `$` interact with the backend.
                    //
                    ...
                    // associated with it, those relationships are instantiated via an empty sails.resource::Collection.
                    ...
                    //
                    //    this.hasMany('sensors', ['sails.resource.Mocks', 'SailsMockSensor']);
                    //
                    // The call above generates a `sensors` property on the instance, which will use the
                    // SailsMockSensor provider, stored in the sails.resource.Mocks module to instantiate sensor
                    // instances.
                    //
                    // The instantiated `sensors` property is an instance of sails.resource::Collection. This
                    ...
                    // sails.resource::Collection. This method also calls Model.belongsTo on the associated model.
                    ...
                    //
                    //    this.belongsTo('system', ['sails.resource.Mocks', 'SailsMockSystem']);
                    //
                    ...
                    // this case, the `system` attribute can only be set to objects of the class SailsMockSystem defined in the
                    // sails.resource.Mocks module.
...
angular
  .module('sails.resource')
  .provider('SailsValidations', function() {
    this.$get = ['$q', function($q) {
